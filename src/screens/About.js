...
function About(props) {
  ...
  return (
    ...
    <View style={{flex: 1, alignItems:'center', justifyContent:'center'}}>
      <Text style={{fontSize: 16}}>About Screen</Text>
      ...
      onPress={()=>dispatch({type:PageContextKeys.userName, payload:'Anees'})}
      >
      <Text>Name Change</Text>
      </TouchableOpacity>
      <TouchableOpacity 
      style={{borderWidth: 1, borderColor: 'red', padding:10, borderRadius:10, marginTop:10}}
      onPress={()=>dispatch({type:PageContextKeys.otpKey, payload:'12345'})}
      >
